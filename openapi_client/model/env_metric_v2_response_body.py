...
class EnvMetricV2ResponseBody(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, cdp, created_at, cve_id, role_id, role_name, td, updated_at, *args, **kwargs):  # noqa: E501
        """EnvMetricV2ResponseBody - a model defined in OpenAPI
    ...
    @convert_js_args_to_python_args
    def __init__(self, cdp, created_at, cve_id, role_id, role_name, td, updated_at, *args, **kwargs):  # noqa: E501
        """EnvMetricV2ResponseBody - a model defined in OpenAPI
