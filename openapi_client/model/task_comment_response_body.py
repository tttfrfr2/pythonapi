...
class TaskCommentResponseBody(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, comment, created_at, id, type, updated_at, user_id, user_name, *args, **kwargs):  # noqa: E501
        """TaskCommentResponseBody - a model defined in OpenAPI
    ...
    @convert_js_args_to_python_args
    def __init__(self, comment, created_at, id, type, updated_at, user_id, user_name, *args, **kwargs):  # noqa: E501
        """TaskCommentResponseBody - a model defined in OpenAPI
