...
class EnvMetricV3ResponseBody(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, created_at, cve_id, ma, mac, mav, mc, mpr, ms, mui, role_id, role_name, updated_at, *args, **kwargs):  # noqa: E501
        """EnvMetricV3ResponseBody - a model defined in OpenAPI
    ...
    @convert_js_args_to_python_args
    def __init__(self, created_at, cve_id, ma, mac, mav, mc, mpr, ms, mui, role_id, role_name, updated_at, *args, **kwargs):  # noqa: E501
        """EnvMetricV3ResponseBody - a model defined in OpenAPI
