...
class Endpoint(object):
    ...
    def __call__(self, *args, **kwargs):
        ...
        api_instance = CveApi()
        api_instance.cve_get_cve_detail  # this is an instance of the class Endpoint
        api_instance.cve_get_cve_detail()  # this invokes api_instance.cve_get_cve_detail.__call__()
        which then invokes the callable functions stored in that endpoint at
        api_instance.cve_get_cve_detail.callable or self.callable in this class
